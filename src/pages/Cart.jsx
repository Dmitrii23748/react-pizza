...
import { clearCarttAction, removeCartItem, plusCartItem, minusCartItem } from '../redux/actions/cartAction';
...
const Cart = () => {
    ...
    const clearCartPizza = () => {
        if ( window.confirm( 'Вы действительно хотите очистить корзину?' ) ) {
            dispatch( clearCarttAction() );
        }
    };

    const removeOnePizza = ( id ) => {
                        ...
                        ? <div className="cart">
                            <div className="cart__top">
                                ...
                                <div className="cart__clear">
                                    ...
                                    <span onClick={ clearCartPizza }>Очистить корзину</span>
                                </div>
                            </div>
